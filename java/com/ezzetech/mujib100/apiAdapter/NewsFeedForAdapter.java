...
public class NewsFeedForAdapter extends RecyclerView.Adapter<NewsFeedForAdapter.NewsFeedViewHoldr> {

    Context context;
    List<Datum> newsFeedList;

    public NewsFeedForAdapter(Context context, List<Datum> newsFeedList) {
    ...
    public void onBindViewHolder(@NonNull NewsFeedViewHoldr holder, int position) {
        Datum newsFeed = newsFeedList.get(position);
    ...
    public class NewsFeedViewHoldr extends RecyclerView.ViewHolder {
        ...
        TextView titleTV,descriptionTV,publishDateTV,linkType;
