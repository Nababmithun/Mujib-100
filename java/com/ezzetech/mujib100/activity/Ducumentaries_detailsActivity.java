...
public class Ducumentaries_detailsActivity extends AppCompatActivity {
  ...
  //  private String url = "https://mujib100.gov.bd/assets/images/videos/video%201%20(7th%20march).mp4";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentaries = intent.getParcelableExtra("documentaries");

        if (mujibApp.getSharedPrefValue()==0){
            captionTV.setText(documentaries.getCaptionEn());
        } else if (mujibApp.getSharedPrefValue()==1) {
            captionTV.setText(documentaries.getCaptionBn());
        }
        ...
        videoUri = Uri.parse(documentaries.getVLink());
        Picasso.get().load(documentaries.getLink()).into(thumbnail);
...
*/
        ...
        intent.putExtra("url",documentaries.getVLink());
        intent.putExtra("thumble",documentaries.getLink());
