...
import com.ezzetech.mujib100.apiAdapter.GlobalNewsAdapter;
...
public class InternationalCelebrationsActivity extends AppCompatActivity implements OnNetworkStateChangeListener {
    ...
    List<Datum> globalNewsList = new ArrayList<>();;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_international_celebrations);
    ...
    private void loadDataFromAPI() {
        ...
        apiService.getGlobalNewsResponse().enqueue(new Callback<GlobalNewsResponse>() {
            @Override
            public void onResponse(Call<GlobalNewsResponse> call, Response<GlobalNewsResponse> response) {
                GlobalNewsResponse eventsResponse = response.body();
                globalNewsList = eventsResponse.getData();
                loadGlobalEvents();
            }

            @Override
            public void onFailure(Call<GlobalNewsResponse> call, Throwable t) {
    ...
    private void loadGlobalEvents() {
        globalNewsAdapter = new GlobalNewsAdapter(this,globalNewsList );
        eventRV.setLayoutManager(new LinearLayoutManager(this));
        eventRV.setAdapter(globalNewsAdapter);
        swipeRefreshLayout.setRefreshing(false);
