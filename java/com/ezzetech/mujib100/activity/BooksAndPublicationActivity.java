...
import com.ezzetech.mujib100.apiAdapter.BooksAdapter;
...
public class BooksAndPublicationActivity extends AppCompatActivity implements OnNetworkStateChangeListener {
    ...
    List<Datum> bookList = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_books_and_publication);
    ...
    private void loadDataFromAPI() {
        ...
        apiService.getBooksResponse().enqueue(new Callback<BooksResponse>() {
            @Override
            public void onResponse(Call<BooksResponse> call, Response<BooksResponse> response) {
                if (response.isSuccessful()){
                    BooksResponse booksResponse = response.body();
                    bookList =  booksResponse.getData();
                    loadBooks();
    ...
    private void loadBooks() {
        booksAdapter = new BooksAdapter(BooksAndPublicationActivity.this,bookList);
