...
public class VirtualTourActivity extends AppCompatActivity implements OnNetworkStateChangeListener {
    ...
    private void init() {
        ...
        webView.setWebViewClient(new WebViewClient());
        webView.loadUrl("https://tour.bangabandhumuseum.org.bd/live/index.html");
