...
public class PressReleaseDetailsActivity extends AppCompatActivity implements OnNetworkStateChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // webView.loadUrl(getIntent().getStringExtra("url"));
        pdfView.fromUri(Uri.parse(getIntent().getStringExtra("url")));
    }
